  ...
  <div class="pagination-bar">
    ...
    <div class="pagination-controls">
      ...
      <div class="page-navigation">
        <button class="page-btn" :disabled="currentPage === 1" @click="$emit('update:currentPage', 1)" :title="$t('admin.pagination.firstPage')">
          <IconChevronsLeft :size="14" />
        </button>
        <button class="page-btn" :disabled="currentPage === 1" @click="$emit('update:currentPage', currentPage - 1)" :title="$t('admin.pagination.previousPage')">
          <IconChevronLeft :size="14" />
        </button>

        <span class="page-indicator"> {{ currentPage }} / {{ totalPages }} </span>

        <button class="page-btn" :disabled="currentPage === totalPages" @click="$emit('update:currentPage', currentPage + 1)" :title="$t('admin.pagination.nextPage')">
          <IconChevronRight :size="14" />
        </button>
        <button class="page-btn" :disabled="currentPage === totalPages" @click="$emit('update:currentPage', totalPages)" :title="$t('admin.pagination.lastPage')">
